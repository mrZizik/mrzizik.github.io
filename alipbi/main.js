...
let words = ["артанди", "беле", "ваша", "гигицо", "г1ама", "гьерк11ва", "гъане", "дидин", "жужука", "ж1ванж1ва", "зини", "иссо", "кене", "к1анча", "к11ара", "кьанк1ала", "кь1ала", "къамер", "лалу", "лъабда", "л1орл1ол","милъе", "нихьва", "осхъел", "пера", "рак1ьар", "солосоло", "тупе", "т1анса", "унса", "хабу", "х1антала", "хъоча", "хьване", "ццицци", "ц1ай", "ц11ибиль", "чане", "ч1ант1а", "ч11инч11иль", "шарбал", "щакибо", "эрхьу", "яше"]
...
const getLetterHtml = (index) => `<div class='letter' style="background: ${colors[index]}" onclick='clickLetter(${index})'><img class="image" src="img/letters/thumb/thum_${capitalizeFirstLetter(symbols[index])}.png" /></br><h1 class="text" style="color: ${colors[index]}">${capitalizeFirstLetter(letters[index])}</h1></div>`;

const getLetterHtmlPage = (index) => `<div class="imageWrapper"><img class="fullImage" src="img/letters/${capitalizeFirstLetter(symbols[index])}.png" /></div><h1 class="fullLetter">${capitalizeFirstLetter(letters[index])}</h1><h1 class="fullText">${capitalizeFirstLetter(words[index])}</h1>`;
